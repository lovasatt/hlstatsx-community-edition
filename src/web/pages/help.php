...
<div class="block">
    ...
    <div style="margin-left:2%;">
        <h1 class="fTitle" style="padding-top:10px;"><a id="players">1. How are players tracked? Or, why is my name listed more than once?</a></h1><br /><br />
            <?php
                $mode = (string)($g_options['Mode'] ?? 'NameTrack');
            ...
            You can use the <a href="<?php echo $scripturl; ?>?mode=search">Search</a> function to find a player by name or <?php echo $uniqueid; ?>.<br /><br />
            <?php
                }
            ?>
            <h1 class="fTitle" style="padding-top:10px;"><a id="points">2. How is the "points" rating calculated?</a></h1><br /><br />
 ...
 Victim Points = Victim Points - (Victim Points / Killer Points)
            ...
            <h1 class="fTitle" style="padding-top:10px;"><a id="hideranking">5. My rank is embarrassing. How can I opt out?</a></h1><br /><br />
            ...
            <strong>Note:</strong> You will still be tracked and you can still view your Player Details page. Use the <a href="<?php echo $scripturl; ?>?mode=search">Search</a> page to find yourself.
    </div>
</div>