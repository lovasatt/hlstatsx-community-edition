...
<div class="block">
	...
	<h1 class="fTitle" style="padding-top:10px;"><a name="players">1. How are players tracked? Or, why is my name listed more than once?</a></h1><br /><br />
	    <?php
                ...
                $mode = isset($g_options['Mode']) ? $g_options['Mode'] : 'NameTrack';
	    ...
	    You can use the <a href="<?php echo htmlspecialchars($g_options['scripturl']); ?>?mode=search">Search</a> function to find a player by name or <?php echo $uniqueid; ?>.<br /><br />
	    <?php
		}
	    ?>
 ...
 Victim Points = Victim Points - (Victim Points / Killer Points)
	    ...
	    <strong>Note:</strong> You will still be tracked and you can still view your Player Details page. Use the <a href="<?php echo htmlspecialchars($g_options['scripturl']); ?>?mode=search">Search</a> page to find yourself.
    </div>
</div>