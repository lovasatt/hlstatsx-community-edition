...
<table width="350" align="center" border="0"><tr class="bg1"><td class="fNormal" align="left">
...
<strong>Note</strong> You should <a href="<?php echo htmlspecialchars($g_options['scripturl']) . "?mode=admin&amp;task=tools_perlcontrol"; ?>" style="text-decoration:underline;font-weight:bold">stop the HLX:CE daemon</a> before resetting the stats. You can restart it after the reset completes.<br /><br />
