...
if (!function_exists('getTeamBucket')) {
...
<?php
        ...
        while (isset($teamdata[$curteam]))
        {
            ...
            $team_display_name = $team_name_str ? htmlspecialchars($team_name_str, ENT_QUOTES, 'UTF-8') : htmlspecialchars(ucfirst(strtolower($team_code_str)), ENT_QUOTES, 'UTF-8');
	    ...
	    if ($team_display_name)
            {
                ...
                <tr style="<?php echo $teamcolor ?>">
                    ...
                    <td style="text-align:left;<?php echo $bordercolor ?>" class="fSmall"><?php
                        ...
                        if ($bucket === 1) {
                            $team_wins = $map_teama_wins;
                        } elseif ($bucket === 2) {
                            $team_wins = $map_teamb_wins;
                        }
...
?>              </td>
        ...
        <td style="<?php echo $bordercolor ?>" class="fSmall"><?php
                if (count($teamdata[$curteam]) > 0)
                {
                    echo sprintf('%.0f', (float)$teamdata[$curteam]['teamping']);
                }
                else
                {
                    echo '&nbsp;';
...
?>              </td>
        <td style="<?php echo $bordercolor ?>" class="fSmall"><?php
                $stamp = (int)($teamdata[$curteam]['teamjointime'] ?? 0);
                if ($stamp > 0)
                {
                    $hours = sprintf('%02d', floor($stamp / 3600));
                    $min   = sprintf('%02d', floor(($stamp % 3600) / 60));
