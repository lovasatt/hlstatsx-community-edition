...
*/
    ...
    if (isset($awardId))
    {
        ...
        ("
            SELECT
                COUNT(hlstats_Players_Awards.awardId)
            FROM
                hlstats_Players_Awards
            WHERE
                hlstats_Players_Awards.playerId = $player
    ...
    else
    {
        ...
        ("
            SELECT
                ...
                hlstats_Awards.name,
                hlstats_Awards.verb,
                COUNT(hlstats_Players_Awards.awardId) AS count,
                hlstats_Awards.awardId
            FROM
                hlstats_Players_Awards
            INNER JOIN
        ...
        ("
            SELECT
                COUNT(DISTINCT hlstats_Players_Awards.awardId)
            FROM
                hlstats_Players_Awards
            WHERE
                hlstats_Players_Awards.playerId = $player
    ...
    $countRow = $db->fetch_row($resultCount);
    ...
    $numitems = ($countRow) ? (int)$countRow[0] : 0;
?>
