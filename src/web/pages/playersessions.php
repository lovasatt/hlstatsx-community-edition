...
?><br /><br />
    <div class="subblock">
        <div style="float:left;">
            Items above are generated from the last <?php echo $deletedays; ?> days.
        </div>
        <div style="float:right;">
            Go to: <a href="<?php echo $scripturl . '?mode=playerinfo&amp;player=' . $player; ?>"><?php echo $pl_name; ?>'s Statistics</a>
        </div>
