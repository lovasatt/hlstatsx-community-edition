...
var SqueezeBox = {
	...
	if (this.options.shadow) {
	    // Modernized shadow handling
	    if (Browser.platform === 'ios' || (Browser.Engine && Browser.Engine.webkit)) {
		this.win.setStyle('-webkit-box-shadow', '0 0 10px rgba(0, 0, 0, 0.7)');
	    } else {
		this.win.setStyle('box-shadow', '0 0 10px rgba(0, 0, 0, 0.7)');
	    }
	}
	...
	// Replaced Hash.some with manual check or Object.each logic
	var keys = Object.keys(this.parsers);
	for(var i=0; i<keys.length; i++) {
	    var key = keys[i];
	    var parser = this.parsers[key];
...
SqueezeBox.parsers = Object.append(SqueezeBox.parsers, {
...
SqueezeBox.handlers = Object.append(SqueezeBox.handlers, {
...
SqueezeBox.parsers.adopt = SqueezeBox.parsers.adopt;