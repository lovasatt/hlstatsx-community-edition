...
dp.sh.Toolbar.Commands = {
    ...
    // UPDATED: Now uses modern Clipboard API with fallback, removing Flash dependency
    CopyToClipboard: {
	...
	func: function(sender, highlighter)
	{
		...
		try {
		    ...
		    if(successful) alert('The code is in your clipboard now');
...
// Replaced Event.observe with a native, framework-independent implementation
(function() {
    var initHighlighter = function() {
	...
	window.addEventListener('load', initHighlighter, false);
    } else if (window.attachEvent) {
	window.attachEvent('onload', initHighlighter);
    } else {
	window.onload = initHighlighter;
    }
})();